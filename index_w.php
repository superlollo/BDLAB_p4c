  ...
  <body>
        ...
        <div id="content-wrapper">
          ...
          <div class="mui-container-fluid">
            ...
            <?php
              $id_w = $_SESSION['id'];
              $query= "SELECT * FROM campagna_di_lavoro WHERE(select count(*) from registrazione where registrazione.campagna=campagna_di_lavoro.id)<(select nr_worker from apre where apre.campagne = campagna_di_lavoro.id)
              and campagna_di_lavoro.id <> all(select campagna from registrazione where worker =$id_w) and data_fine >= current_date and periodo_registrazione >= current_date ORDER BY periodo_registrazione" ;
                ...
                ?>
                  ...
                  <div class="card cyan darken-3" >
                    ...
                    <div class="card-action">
                      <a href="registrazione_campagna.php?id=<?= $row['id']?>">Registrati</a>
                    </div>
                  </div>
                </div>
                </div>
